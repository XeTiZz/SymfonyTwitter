...
class DashboardController extends AbstractDashboardController
{
    ...
    public function index(): Response
    {
        ...
        return $this->redirect($adminUrlGenerator->setController(MessagePublicCrudController::class)->generateUrl());
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linktoRoute('Retour sur le site', 'fas fa-home', 'index');
    }
}
